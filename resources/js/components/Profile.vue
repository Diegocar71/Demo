                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#change-password" data-toggle="tab">Cambiar Contraseña</a></li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="activity">
                                    <h3 class="text-center">Ver Actividad</h3>
                                </div>
                                <!-- Setting Tab -->
                                    ...
                                    <form @click.prevent="updateInfo" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="float-right d-sm-inline text-muted">Usuario desde: <span>{{form.created_at|myDate}}</span></div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="tab-pane" id="change-password">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button @click.prevent="updatePassword" type="submit" class="btn btn-success">Grabar Contraseña</button>
                                        </div>
                                    </div>
                                    </form>
                                </div>
